...
class Configuartion:
    ...
    def __init__(self,
        ...
        current_time_stamp:str = CURRENT_TIME_STAMP     # while reading data from AWS or any other we cpature time
        ) -> None:
        try:
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            artifact_dir = self.training_pipeline_config.artifact_dir        # commmon for every pipeline
    ...
    def get_training_pipeline_config(self)->TrainingPipelineConfig:
        try:
            ...
            logging.info(f"Training pipleine completed: {training_pipeline_config}")
